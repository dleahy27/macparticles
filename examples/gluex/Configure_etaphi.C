{
  ...
  auto info = TrainingInfo{"k+"};

  info.treeName = "simtree";
  info.reconFile = "./data/kp_training.root";
  ...
  info.treeName = "simtree";
  info.reconFile = "./data/km_training.root";
 ...
 /*********************************************************************************************************/
  ...
  /*********************************************************************************************************/
  info = TrainingInfo{"gamma1"};


  info.treeName = "simtree";
  info.reconFile = "./data/gamma_training.root";
